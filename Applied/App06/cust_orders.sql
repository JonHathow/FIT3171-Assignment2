...
ALTER TABLE customer
    ADD CONSTRAINT chk_level CHECK ( cust_level IN ( 'B', 'G', 'S' ) );

COMMENT ON COLUMN customer.cust_no IS
    'Customer number as unique id to identify each customer';
